...
.. toctree::
  ...
  built-in-functions-specific-to-particular-target-machines/argument-types
  built-in-functions-specific-to-particular-target-machines/directly-mapped-integer-functions
  built-in-functions-specific-to-particular-target-machines/directly-mapped-media-functions
  built-in-functions-specific-to-particular-target-machines/raw-read-write-functions
  built-in-functions-specific-to-particular-target-machines/other-built-in-functions
...
.. toctree::
  ...
  built-in-functions-specific-to-particular-target-machines/paired-single-arithmetic
  built-in-functions-specific-to-particular-target-machines/paired-single-built-in-functions
  built-in-functions-specific-to-particular-target-machines/mips-3d-built-in-functions
...
.. toctree::
  ...
  built-in-functions-specific-to-particular-target-machines/basic-powerpc-built-in-functions-available-on-all-configurations
  built-in-functions-specific-to-particular-target-machines/basic-powerpc-built-in-functions-available-on-isa-2.05
  built-in-functions-specific-to-particular-target-machines/basic-powerpc-built-in-functions-available-on-isa-2.06
  built-in-functions-specific-to-particular-target-machines/basic-powerpc-built-in-functions-available-on-isa-2.07
  built-in-functions-specific-to-particular-target-machines/basic-powerpc-built-in-functions-available-on-isa-3.0
  built-in-functions-specific-to-particular-target-machines/basic-powerpc-built-in-functions-available-on-isa-3.1
...
.. toctree::
  ...
  built-in-functions-specific-to-particular-target-machines/powerpc-altivec-built-in-functions-on-isa-2.05
  built-in-functions-specific-to-particular-target-machines/powerpc-altivec-built-in-functions-available-on-isa-2.06
  built-in-functions-specific-to-particular-target-machines/powerpc-altivec-built-in-functions-available-on-isa-2.07
  built-in-functions-specific-to-particular-target-machines/powerpc-altivec-built-in-functions-available-on-isa-3.0
  built-in-functions-specific-to-particular-target-machines/powerpc-altivec-built-in-functions-available-on-isa-3.1
