...
.. option:: -fcf-protection=[full|branch|return|none|check]
  ...
  You can also use the :option:`nocf_check` attribute to identify
...
.. option:: -fstack-protector-explicit
  ...
  have the :option:`stack_protect` attribute.
...
.. option:: -fstack-limit-register=reg
  ...
  :option:`no_stack_limit` function attribute (see :ref:`function-attributes`).
