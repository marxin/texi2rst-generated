...
.. code-block:: c++
  ...
  (define_attr :samp:`{name}` :samp:`{list-of-values}` :samp:`{default}` )
...
.. code-block:: c++
  ...
  (define_enum_attr " :samp:`{attr}` " " :samp:`{enum}` " :samp:`{default}` )
...
.. code-block:: c++
  ...
  (define_asm_attributes [ :samp:`{attr-sets}` ])
...
.. code-block:: c++
  ...
  (define_delay :samp:`{test}`
                [ :samp:`{delay-1}` :samp:`{annul-true-1}` :samp:`{annul-false-1}`
                 :samp:`{delay-2}` :samp:`{annul-true-2}` :samp:`{annul-false-2}`
                 ...])
...
.. code-block:: c++
  ...
  (define_automaton :samp:`{automata-names}` )
...
.. code-block:: c++
  ...
  (define_cpu_unit :samp:`{unit-names}` [ :samp:`{automaton-name}` ])
...
.. code-block:: c++
  ...
  (define_query_cpu_unit :samp:`{unit-names}` [ :samp:`{automaton-name}` ])
...
.. code-block:: c++
  ...
  (define_insn_reservation :samp:`{insn-name}` :samp:`{default_latency}`
                           :samp:`{condition}` :samp:`{regexp}` )
...
.. code-block:: c++
  ...
  (define_reservation :samp:`{reservation-name}` :samp:`{regexp}` )
...
.. code-block:: c++
  ...
  (define_bypass :samp:`{number}` :samp:`{out_insn_names}` :samp:`{in_insn_names}`
                 [ :samp:`{guard}` ])
...
.. code-block:: c++
  ...
  (exclusion_set :samp:`{unit-names}` :samp:`{unit-names}` )
  (presence_set :samp:`{unit-names}` :samp:`{patterns}` )
  (final_presence_set :samp:`{unit-names}` :samp:`{patterns}` )
  (absence_set :samp:`{unit-names}` :samp:`{patterns}` )
  (final_absence_set :samp:`{unit-names}` :samp:`{patterns}` )
